...
En esta sección se van a dar definiciones, operaciones y propiedades de los
conjuntos. Todas las funciones que terminan en <<'>> en esta sección son
válidas para las dos representaciones de conjuntos que hemos presentado en la
sección anterior \ref{sec:rep_conjuntos}. La representación utilizada para los
ejemplos será la de conjuntos como listas ordenadas sin repetición.

Teniendo en cuenta que en las secciones venideras vamos a trabajar con
conjuntos como listas sin duplicados, para cada definición se da además una
función equivalente a la dada sólo compatible con dicha representación. En
general esta segunda definición será mucho más sencilla y eficiente.
